...
(설레는(기대하는)) 지금부터 회의를 시작하도록 하겠습니다.

4
00:00:03,600 --> 00:00:08,000
(설레는(기대하는)) 오늘 저희가 다룰 회의 안건은 프로젝트 개발 진행 사항 공유입니다.

5
00:00:08,000 --> 00:00:10,800
(설레는(기대하는)) 서영님부터 진행 사항 말씀해 주세요.

6
00:00:10,800 --> 00:00:17,400
(설레는(기대하는)) 네, 저는 1차 자막을 받아 발음 정교화 모델을 개발 중입니다.
...
8
00:00:21,800 --> 00:00:31,600
(일상적인) 네, 기존 오픈 소스에 올라가 있는 한국어 특화 모델과 새롭게 개발한 모델의 성능을 비교해 본 결과 대략 30% 정도 향상되었습니다.
...
(설레는(기대하는)) 이번 주 대로 모델 개발 마무리해서 공유해 주세요.

11
00:00:36,000 --> 00:00:40,000
(설레는(기대하는)) 다음으로 저는 입모양 분석 모델을 개발 중에 있습니다.
...
```
<aside>
➡️

**출력 srt 내에서 문맥 기반 Emotion Classification model을 통해 감정 상태가 추가된 문장을 볼 수 있음**
