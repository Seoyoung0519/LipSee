...
### **Live Demo**
- **API 문서**: https://lipsee-emotion-api.onrender.com/docs
- **헬스체크**: https://lipsee-emotion-api.onrender.com/health

### **배포 상태**
- ✅ **ONNX Runtime 사용으로 메모리 대폭 절약**
- ✅ **PyTorch 제거: ~800MB → ~50MB (90% 절약)**
- ✅ **양자화된 int8 모델 우선 사용으로 추가 최적화**
- ✅ 로컬 onnx/ 폴더의 모델 파일 사용
- ✅ 자동 헬스체크 및 모니터링

### **메모리 최적화 전략**
- **ONNX Runtime**: PyTorch 대신 사용하여 메모리 90% 절약
- **양자화된 모델**: `model.int8.onnx` 우선 사용으로 추가 메모리 절약
- **로컬 모델**: HuggingFace 다운로드 불필요
- **CPU 최적화**: CPU 전용 실행으로 메모리 효율성 향상
- **모델 경로**: `./onnx/` 폴더에서 모델 파일 직접 로드
